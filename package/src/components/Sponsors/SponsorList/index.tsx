      ...
      <div className='container max-w-8xl mx-auto px-5 2xl:px-0'>
        ...
        <div className='grid grid-cols-12 gap-8 mt-14'>
          {sponsors.map((sponsor, index) => (
            <SponsorCard key={index} sponsor={sponsor} className="col-span-12 sm:col-span-6 lg:col-span-4" />
          ))}
          {placeholders.map((_, index) => (
            <div key={`placeholder-${index}`} className="col-span-12 sm:col-span-6 lg:col-span-4">
